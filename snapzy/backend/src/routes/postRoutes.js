...
import { createPost, getFeed, getExplore, getByUser, toggleLike, addComment, replyComment, updateCaption, deletePost, toggleBookmark, getBookmarks, trendingHashtags } from '../controllers/postController.js';
...
router.get('/trending', requireAuth, trendingHashtags);
...
router.post('/:postId/reply', requireAuth, replyComment);
